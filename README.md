...
- Luokka ja olio : Luokka Book tehtävä on tiedostossa BookExercise, jossa tehdään siis vertailumetodi  public void CompareBook(Book book)
...
- Ja sitten Ominaisuudet : Luokka Author on tehtynä tiedostoon BookAndAuthor, jossa pääohjelmassa tehtiin oliota author-luokasta.
